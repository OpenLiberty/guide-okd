...
= Deploying microservices on an Origin Community Distribution of Kubernetes (OKD) using Minishift

[.hidden]
NOTE: This repository contains the guide documentation source. To view the guide in published form, view it on the https://openliberty.io/guides/{projectid}.html[Open Liberty website^].

Explore how to utilize Minishift to deploy microservices to an Origin Community Distribution of Kubernetes cluster. 
...
[role="no_copy"]
----
SET PATH=C:\Users\MaiHameed\.minishift\cache\oc\v3.11.0\windows;%PATH%
...
=== Containerizing the inventory microservice

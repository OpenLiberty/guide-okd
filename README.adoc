...
OKD, formerly known as OpenShift Origin, is the upstream open source project for all OpenShift products. OKD is a Kubernetes-based platform with
...
to make the deployment and management of cloud applications easier.

To learn more about OKD, check out the https://www.okd.io/[official OKD page^]. To learn more about the different platforms that Red Hat OpenShift offers, 
check out the https://docs.openshift.com[official OpenShift documentation^]. If you would like to learn more about Kubernetes, check out 
...
Minishift is based on OKD 3.11. To run OKD 4.1 or newer on your local system,
you can instead use the CodeReady Containers tool. To learn how to use
CodeReady Containers, check out
https://developers.redhat.com/blog/2019/09/05/red-hat-openshift-4-on-your-laptop-introducing-red-hat-codeready-containers/[Red
Hat's guide].
...
To simplify the local deployment process, the built-in Minishift Docker daemon can be reused. Reusing the Minishift Docker daemon allows your system to 
...
following command to point your command-line session to use the Minishift's daemon:

...
To run OKD 4.1 or newer on your local system, you can instead use the CodeReady Containers tool.
To learn how to use CodeReady Containers, check out the
https://openliberty.io/guides/crc-openshift.html[CodeReady Containers guide^].

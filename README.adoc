...
To learn more about the different platforms that Red Hat OpenShift offers, check out the 
...
following command to point your shell to use the Minishift's daemon:
...
To revert back to your default Docker settings, simply close your shell session.

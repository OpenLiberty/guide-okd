...
To simplify the local deployment process, the built-in Minishift Docker daemon can be reused to avoid having to build a Docker registry on the host machine. 

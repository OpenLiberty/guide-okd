...
To speed up the development process, the built-in Minishift Docker daemon can be reused to avoid having to build a Docker registry on the host machine. 
To reuse the Docker daemon, run the following command:

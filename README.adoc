...
To simplify the local deployment process, the built-in Minishift Docker daemon can be reused.
Reusing the Minishift Docker daemon allows your system to connect to it, and use the internal Docker registry.
This avoids having to build a Docker registry on your machine.
